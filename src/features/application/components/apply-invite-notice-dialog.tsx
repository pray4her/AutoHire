...
function ApplyInviteNoticeBody({
  ...
  return (
    <div className="relative rounded-[1.1rem] border border-[color:var(--border)] bg-[color:var(--background-elevated)]">
      ...
      <div className="relative flex flex-col">
                ...
                <li key={item.title}>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-[0.98rem] leading-6 font-semibold text-[color:var(--foreground)]">
                        {item.title}
                      </p>
        ...
        <div className="flex shrink-0 flex-col gap-4 border-t border-[color:var(--border)] bg-white/82 px-6 py-5 sm:px-8 sm:py-6">
